import { BlockIcon, CheckmarkCircleIcon, Flex, Link, OpenNewIcon, RefreshIcon } from '@solarswap/uikit'
...
const TransactionRow: React.FC<TransactionRowProps> = ({ txn }) => {
  ...
  return (
    <TxnLink href={getAstraScanLink(txn.hash, 'transaction', chainId)} external>
