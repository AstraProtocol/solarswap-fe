...
const Search = () => {
	...
	const { savedPools, savedTokens, addPool, addToken } = useInfoUserSavedTokensAndPools(parseInt(CHAIN_ID))
	...
	// 							<HoverRowLink
	// 								onClick={() =>
	// 									handleItemClick(`/info${chainPath}/tokens/${token.address}${stableSwapQuery}`)
	// 								}
	...
	// 									{!isXs && !isSm && (
	// 										<Text textAlign="end">${formatAmount(token.volumeUSD)}</Text>
	// 									)}
	// 									{!isXs && !isSm && (
	// 										<Text textAlign="end">${formatAmount(token.liquidityUSD)}</Text>
	// 									)}
	// 								</ResponsiveGrid>
	// 							</HoverRowLink>
	// 						)
	...
	// 							<HoverRowLink
	// 								onClick={() =>
	// 									handleItemClick(`/info${chainPath}/pairs/${p.address}${stableSwapQuery}`)
	// 								}
	...
	// 									{!isXs && !isSm && (
	// 										<Text textAlign="end">${formatAmount(p.volumeUSDWeek)}</Text>
	// 									)}
