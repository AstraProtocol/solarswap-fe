...
import { AddIcon, Button, InjectedModalProps, Text } from '@solarswap/uikit'
...
const ConfirmRemoveSingleLiquidityModal: React.FC<InjectedModalProps & ConfirmRemoveSingleLiquidityModalProps> = ({
  title,
  onDismiss,
  customOnDismiss,
  attemptingTxn,
