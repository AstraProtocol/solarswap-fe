...
// 			}://${WALLET_CONNECT_RELAY}`,
// 			metadata: {
// 				name: "Solar Swap",
// 				description:
// 					"Swap, earn and win ASA through yield farming on the first DEFI exchange for Astra token.",
// 				url: window.location.origin,
// 				icons: [
// 					"https://salt.tikicdn.com/ts/ta/8e/80/26/80c694f8ce25376dd97aa55d251a459f.png",
// 				],
// 			},
// 		});
