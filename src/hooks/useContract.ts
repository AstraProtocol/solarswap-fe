...
import { ChainId, WETH } from '@solarswap/sdk'
import ISolarPairABI from '../config/abi/ISolarPair.json'
import ENS_PUBLIC_RESOLVER_ABI from '../config/abi/ens-public-resolver.json'
import ENS_ABI from '../config/abi/ens-registrar.json'
import { ERC20_BYTES32_ABI } from '../config/abi/erc20'
import ERC20_ABI from '../config/abi/erc20.json'
import ZAPIN_ABI from '../config/abi/ZapIn.json'
import WETH_ABI from '../config/abi/weth.json'
import multiCallAbi from '../config/abi/Multicall.json'
import { getContract, getProviderOrSigner } from '../utils'

import { ZapIn } from '../config/abi/types/ZapIn'
import { ISolarPair } from '../config/abi/types/ISolarPair'
...
// 	const { library } = useActiveWeb3React()
// 	return useMemo(() => getSolarSquadContract(library.getSigner()), [library])
// }
...
export function usePairContract(pairAddress?: string, withSignerIfPossible?: boolean): ISolarPair | null {
	return useContract(pairAddress, ISolarPairABI, withSignerIfPossible)
}
