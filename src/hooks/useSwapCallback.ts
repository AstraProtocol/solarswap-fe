...
import { SwapParameters, Trade } from '@solarswap/sdk'
...
function swapErrorToUserReadableMessage(error: any, t: TranslateFunction) {
	...
	switch (reason) {
		...
		case 'SolarswapRouter: INSUFFICIENT_OUTPUT_AMOUNT':
		case 'SolarswapRouter: EXCESSIVE_INPUT_AMOUNT':
			return t('This transaction will not succeed due to price movement. Try increasing your slippage tolerance.')
		case 'SolarswapZapIn: INVALID_POOL':
