import { ChainId, Pair, Token } from '@solarswap/sdk'
...
export function useGasPrice(): string {
	...
	return user.gasPrice
	// return chainId === ChainId.MAINNET.toString() ? user.gasPrice : GAS_PRICE_GWEI.testnet
}
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
	return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Asa-LP', 'Solar LPs')
}
