...
const getFarmBaseTokenPrice = (
  ...
  if (farm.quoteToken.symbol === tokens.wasa.symbol) {
  ...
  if (quoteTokenFarm.quoteToken.symbol === tokens.wasa.symbol) {
...
const getFarmQuoteTokenPrice = (
  ...
  if (farm.quoteToken.symbol === 'WASA') {
    return bnbPriceBusd
  }
  ...
  if (quoteTokenFarm.quoteToken.symbol === 'WASA') {
...
const getFarmsPrices = (farms: SerializedFarm[]) => {
  const bnbBusdFarm = farms.find((farm) => {
    return farm.token.symbol === 'USDT' && farm.quoteToken.symbol === 'WASA'
  })
